...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-description"> Masukan Berkas Pengajuan Nasabah </p>
            <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                @csrf
                ...
                <button type="submit" class="btn btn-success btn-rounded btn-fw"><i class="ti-plus"> Buat Data</i></button>
            </form>
        </div>
    </div>
</div>
