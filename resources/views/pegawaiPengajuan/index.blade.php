        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('pegawaiPengajuan.create') }}" class="btn btn-success text">Masukan Berkas!</a>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @if ($pegawaiPengajuan->count() > 0)
                                    @foreach ($pegawaiPengajuan as $rs)
                                        <tr>
                                            ...
                                            <td class="align-middle justify-center">
                                                <a href="{{ route('pegawaiPengajuan.show', $rs->id) }}"
                                                    class="btn-outline-grey"><i class="mdi mdi-eye-outline"></i></a>
                                                <form action="{{ route('pegawaiPengajuan.destroy', $rs->id) }}" method="POST"
