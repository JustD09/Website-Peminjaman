        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('pengajuan.create') }}" class="btn btn-success text">Masukan Berkas!</a>
                                ...
                                @if ($pengajuan->count() > 0)
                                    @foreach ($pengajuan as $rs)
                                        <tr>
                                            ...
                                            <td class="align-middle justify-center">
                                                <a href="{{ route('pengajuan.show', $rs->id) }}"
                                                    class="btn-outline-grey"><i class="mdi mdi-eye-outline"></i></a>
                                                <a href="{{ route('pengajuan.edit', $rs->id) }}"
                                                    class="btn-outline-grey"><i class="ti-pencil-alt"></i></a>
                                                <form action="{{ route('pengajuan.destroy', $rs->id) }}" method="POST"
