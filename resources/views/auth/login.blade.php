                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <h6 class="font-weight-light">Silahkan Login dan pastikan email dan password data anda !</h6>
                            <form method="POST" action="{{ route('login.action') }}" class="pt-3 needs-validation">
                                @csrf
                                @if ($errors->any())
